...
Template.rLokacije.rendered = function() {
...
function reRenderReport() {
    ...
    Meteor.call("rLokacijeTabela", Services_id, Session.get('Lokacije'), Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        $('#tabelica').html(result);
    });
    // Chart 1
    Meteor.call("rLokacijeChart1", Session.get("Services"), Session.get('Lokacije'), Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart1Container').highcharts(result);
    });
    // Chart 2
    Meteor.call("rLokacijeChart2", Services_id, Session.get('Lokacije'), Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
