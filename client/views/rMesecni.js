...
Template.rMesecni.rendered = function() {
...
function reRenderReport() {
    ...
    Meteor.call("rMesecniTabela", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        $('#tabelica1').html(result);
    });
    // Chart 1
    Meteor.call("rMesecniChart1", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart1Container').highcharts(result);
    });
    // Chart 2
    Meteor.call("rMesecniChart2", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart2Container').highcharts(result);
    });
    // Chart 3
    Meteor.call("rMesecniChart3", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart3Container').highcharts(result);
    });
    // Chart 4
    Meteor.call("rProsekZatvaranja", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {

        $('#tabelica2').html(result);
    });
}
