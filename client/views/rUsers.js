...
Template.rUsers.rendered = function() {
...
function reRenderReport() {
    ...
    Meteor.call("rUsersTabela", services, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        $('#tabelica').html(result);
    });
    // Chart 1
    Meteor.call("rUsersChart1", services, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart1Container').highcharts(result);
    });
    // Chart 2
    Meteor.call("rUsersChart2", services, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart2Container').highcharts({
                ...
                title: {
                    text: 'Završeni tiketi po izvršiocima'
                },
                tooltip: {
