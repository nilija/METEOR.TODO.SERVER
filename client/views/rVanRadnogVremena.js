Template.rVanRadnogVremena.helpers({
    clients: function() {
...
Template.rVanRadnogVremena.events({
...
Template.rVanRadnogVremena.rendered = function() {
...
function reRenderReport() {
    ...
    Meteor.call("rRadnoVremeCount", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {

        // Tabela
        Meteor.call("rVanRadnogVremenaTabela", Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), result,
            function (error, result) {
                $('#tabelica').html(result);
            });
        Meteor.call("rNaplata", Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), result,
            function (error, result) {
                $('#tabelica_').html(result);
            });
        // Chart 1
        Meteor.call("rVanRadnogVremenaChart1", Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), result,
            function (error, result) {
                //console.log(error);
                //console.log(result);
        ...
        // Chart 2
        Meteor.call("rVanRadnogVremenaChart2", Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), result,
            function (error, result) {
                //console.log(error);
                //console.log(result);
