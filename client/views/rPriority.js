...
Template.rPriority.rendered = function() {
...
function reRenderReport() {
    ...
    Meteor.call("rPriorityTabela", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        $('#tabelica').html(result);
    });
    // Chart 1
    Meteor.call("rPriorityChart1", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
        $('#chart1Container').highcharts(result);
    });
    // Chart 2
    Meteor.call("rPriorityChart2", Services_id, Session.get("selected"), Session.get("selectedL"), Session.get("selectedG"), function (error, result) {
        //console.log(error);
        //console.log(result);
